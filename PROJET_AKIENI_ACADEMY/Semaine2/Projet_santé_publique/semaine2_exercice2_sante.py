...
# ============================================================
# --- DONNEES BRUTES ---
budget_fcfa = 87450000 # underscore pour lisibilite des grands nombres
...
print(f' Densite medicale{'        '}: {densite_medicale} medecins / 1000 hab')
print(f' Taux mortalite {'         '}: {taux_mortalite} %')
print(f' Taux occupation{'         '}: {taux_occupation} %')
print("ANALYSYSE PHARMACIE")
